...
def compare_algorithms(data_path: Path, save_dir: Path):
    """Compare AEKF and UKF"""
    print("\n" + "="*50)
    print("Comparing AEKF vs UKF")
    print("="*50)
...
def main():
    ...
    print("Summary")
    print("="*50)
    print(f"{'Algorithm':<10} {'RMSE':<12} {'MAE':<12} {'Max Error':<12}")
    print("-"*50)
    print(f"{'AEKF':<10} {aekf_metrics['rmse']:.4f}%{'':<6} {aekf_metrics['mae']:.4f}%{'':<6} {aekf_metrics['max_error']:.4f}%")
    print(f"{'UKF':<10} {ukf_metrics['rmse']:.4f}%{'':<6} {ukf_metrics['mae']:.4f}%{'':<6} {ukf_metrics['max_error']:.4f}%")
